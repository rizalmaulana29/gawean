						...
						<tbody>
							<tr>
								<td>
									...
									<p style="margin:0;font-size:16px;line-height:24px">Silahkan ikuti instruksi pembayaran di email ini dan selesaikan pembayaran sebelum: <b>{{date("YMd H:i",$transdata->expired_at)}}</b></p><!-- date("Y-m-d h:i:sa", $d) -->
								</td>
							</tr>
						</tbody>
					</table>
