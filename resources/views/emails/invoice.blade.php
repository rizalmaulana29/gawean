	...
	<table style="border-collapse:collapse;width:100%">
		...
		<tbody>
			<tr>@if($varian == 'Aqiqah')
				...
				@elseif
				<td style="padding:15px 16px"><img src="https://storage.googleapis.com/donol.cinte.id/asp/SANUSA%20COLOR-05-05.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="sanusafood.id" style="border:none;max-width:100%;display:block;width:192px" class="CToWUd"></td>
				@else
